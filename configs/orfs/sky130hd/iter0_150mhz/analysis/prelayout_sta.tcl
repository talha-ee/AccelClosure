...
set odb_file \
  /workspace/AccelClosure/orfs_runs/results/sky130hd/accelclosure_ws_array/iter0_150mhz/1_synth.odb

set sdc_file \
  /workspace/AccelClosure/orfs_runs/results/sky130hd/accelclosure_ws_array/iter0_150mhz/1_synth.sdc
...
puts "============================================================"
puts " ACCELCLOSURE ITERATION-0 POST-SYNTHESIS STA"
puts "============================================================"

puts "DESIGN_NAME=$design_name"
puts "TARGET_PERIOD_NS=6.667"
puts "TARGET_FREQUENCY_MHZ=150"
...
puts ""
puts "ACCELCLOSURE_POSTSYNTH_STA_COMPLETE"
