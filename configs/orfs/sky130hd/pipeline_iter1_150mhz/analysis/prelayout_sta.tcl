...
set odb_file \
  /workspace/AccelClosure/orfs_runs/results/sky130hd/accelclosure_ws_array/pipeline_iter1_150mhz/1_synth.odb

set sdc_file \
  /workspace/AccelClosure/orfs_runs/results/sky130hd/accelclosure_ws_array/pipeline_iter1_150mhz/1_synth.sdc

set liberty_file \
  /OpenROAD-flow-scripts/flow/platforms/sky130hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib

puts "============================================================"
puts " ACCELCLOSURE PIPELINED ITERATION 1 STA"
puts "============================================================"

puts "DESIGN_NAME=$design_name"
puts "TARGET_PERIOD_NS=6.667"
puts "TARGET_FREQUENCY_MHZ=150.0"
...
puts ""
puts "ACCELCLOSURE_PIPELINE_ITER1_STA_COMPLETE"
